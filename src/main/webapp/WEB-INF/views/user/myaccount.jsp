...
<html>
    ...
    <body>
        ...
        <h1>My Profile!</h1>
        <table>
            <tr><td><b>Full Name</b></td>       <td>${Profile.username}</td> </tr>
           ...
           <tr><td><b>User Role</b></td>      <td>${Profile.AUTHORITY}</td> </tr>
            ...
            <tr><td><b>Full Name</b></td>  <td>${Profile.password}</td></tr>
     ...
     <h5>
                 <b>  <a href="${pageContext.request.contextPath}/user/editProfile/${Profile.id}">Edit Profile</a>
     </body>
</html>
