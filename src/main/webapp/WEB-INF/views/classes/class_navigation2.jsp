      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">          
            <li><a href="${pageContext.request.contextPath}/editclassform/${classes.id}">Edit</a></li>
            <li class="divider"></li>
            <li><a href="${pageContext.request.contextPath}/removeclass/${classes.id}">Remove</a></li>
            <li class="divider"></li>
          </ul>
        </li>
      </ul>
